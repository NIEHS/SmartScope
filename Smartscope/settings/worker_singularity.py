...
SECRET_KEY = os.getenv('SECRET_KEY')  # 'y9r9sj*s(e_ll@_#1$*r2h8+chhhoq&tjspg9n64ef73ff^o9t'
...
if os.getenv('MYSQL_HOST') == 'localhost' and os.getenv('MYSQL_IN_ENV') == 'true':
    DATABASES['default']['OPTIONS'] = {
        'unix_socket': os.path.join(os.getenv('CONDA_PREFIX'), 'var/run/mysql.sock'),
    }
...
PLUGINS_FILE = os.path.join(BASE_DIR, '../config/smartscope/plugins.json')
# SMARTSCOPE = {
#     'Finders': {
#         'FFT finder': {
#             'method': 'fft_method',
...
LOGIN_REDIRECT_URL = '/autoscreenViewer'
