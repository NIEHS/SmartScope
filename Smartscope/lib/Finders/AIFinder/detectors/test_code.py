...
square_weights = '/home/bouvettej2/Smartscope-beta/Template_files/weights/square_weights/new_r50_final.pth'

if not torch.cuda.is_available():

    coord, labels, img_mult, scale = detect(
        '/auto_screening/testing/20220510_demo_test/1_grid_1/grid_1_atlas/grid_1_atlas.mrc', device='cpu', weights=square_weights)
else:
    coord, labels, img_mult, scale = detect(
        '/auto_screening/testing/20220510_demo_test/1_grid_1/grid_1_atlas/grid_1_atlas.mrc', device='0', weights=square_weights)
...
# square_path  = '/hpc/home/qh36/research/qh36_2/all_data/newer_group/20210812_0804_T2-3/4_T2-4/T2-4_square13/T2-4_square13.mrc'
...
# hole_coords,_ = detect_holes_yolo(square, weights_circle='runs/circle_weights/aug_27_yolo_circle_weights.pt')
