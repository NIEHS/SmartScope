...
class GridCollectionParamsForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = dict(
            ...
            offset_targeting='Enable random targeting off-center to sample the ice gradient and carbon mesh particles.',
            offset_distance='Override the random by an absolute value in microns. Use -1 to disable'
        )
