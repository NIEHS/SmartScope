...
urlpatterns = [
    ...
    path('preprocessing/getpipeline/',views.PreprocessingPipeline().getpipeline,name='getPreprocessingPipeline'),
    path('preprocessing/<grid_id>',views.PreprocessingPipeline().get_grid_pipeline,name='getPreprocessingPipeline'),
    path('preprocessing/setpipeline/<pipeline>/',views.PreprocessingPipeline().setpipeline,name='setPreprocessingPipeline'),
    path('preprocessing/setpipeline/<pipeline>/<grid_id>',views.PreprocessingPipeline().setpipeline,name='setPreprocessingPipeline'),
